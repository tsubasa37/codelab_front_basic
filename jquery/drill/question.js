...
$('col-sm-8,#q50 span,#q51 span,#q52 span').css('color','red');
  // 問題6:子セレクター
...
$('.q9 ~ p').css('color','red');
  ...
  $("li.secound").siblings().css('color','red');
  // 問題45:attrメソッド
